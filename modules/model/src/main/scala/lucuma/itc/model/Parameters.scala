...
// final case class UserAperture(diameter: Double, skyAperture: Double)
//     extends ApertureMethod
//
...
// final case class IfuRadial(skyFibres: Int, minOffset: Double, maxOffset: Double)
//     extends IfuMethod
...
//     centerX: Double,
//     centerY: Double
// ) extends IfuMethod // Sum of NIFS IFU elements in rectangular aperture
// final case class IfuSum(skyFibres: Int, num: Double, isIfu2: Boolean)
//     extends IfuMethod // Sum of GMOS fibers in circular aperture
//
// // === Observation Details
//
// final case class ObservationDetails(
