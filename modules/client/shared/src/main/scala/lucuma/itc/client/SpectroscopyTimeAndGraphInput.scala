...
final case class SpectroscopyIntegrationTimeAndGraphInput(
...
object SpectroscopyIntegrationTimeAndGraphInput {
  ...
  given Encoder.AsObject[SpectroscopyIntegrationTimeAndGraphInput] = a =>
    JsonObject(
  ...
  given Eq[SpectroscopyIntegrationTimeAndGraphInput] =
    Eq.by { a =>
      (
        a.wavelength,
        a.signalToNoiseAt,
