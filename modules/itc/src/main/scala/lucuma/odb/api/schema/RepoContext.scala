...
// import lucuma.odb.api.repo.{AtomRepo, ExecutionEventRepo, ObservationRepo, ItcRepo, ProgramRepo, StepRepo}
...
final class RepoContextOps[F[_]](val self: Context[ItcRepo[F], _]) {
...
trait ToRepoContextOps {
  implicit def toRepoContextOps[F[_]](self: Context[ItcRepo[F], _]): RepoContextOps[F] =
