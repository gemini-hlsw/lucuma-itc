...
object SpatialProfileType {
  case object PointSource extends SpatialProfileType
  case object UniformSource extends SpatialProfileType
  case object GaussianSource extends SpatialProfileType

  implicit val EnumeratedSpatialProfileType: Enumerated[SpatialProfileType] =
    Enumerated.of(
      PointSource,
      UniformSource,
      GaussianSource
