...
import lucuma.itc.base.GaussianMorphology;
import lucuma.itc.base.ImagingArrayRecipe;
import lucuma.itc.base.ImagingResult;
import lucuma.itc.base.Recipe$;
import lucuma.itc.base.SEDFactory;
import lucuma.itc.base.SpectroscopyArrayRecipe;
import lucuma.itc.base.SpectroscopyResult;
import lucuma.itc.base.USBMorphology;
import lucuma.itc.base.Validation;
import lucuma.itc.base.VisitableMorphology;
...
import lucuma.itc.operation.ImageQualityCalculationFactory;
import lucuma.itc.operation.ImagingS2NCalculatable;
import lucuma.itc.operation.ImagingS2NCalculationFactory;
import lucuma.itc.operation.PeakPixelFlux;
import lucuma.itc.operation.Slit;
import lucuma.itc.operation.Slit$;
import lucuma.itc.operation.SlitThroughput;
import lucuma.itc.operation.SourceFraction;
import lucuma.itc.operation.SourceFractionFactory;
import lucuma.itc.operation.SpecS2N;
import lucuma.itc.operation.SpecS2NSlitVisitor;
import lucuma.itc.shared.BackgroundData;
import lucuma.itc.shared.ChartAxis;
import lucuma.itc.shared.ChartAxisRange;
import lucuma.itc.shared.FinalS2NData;
import lucuma.itc.shared.GmosParameters;
import lucuma.itc.shared.ITCChart;
import lucuma.itc.shared.IfuSum;
import lucuma.itc.shared.ItcImagingResult;
import lucuma.itc.shared.ItcParameters;
import lucuma.itc.shared.ItcSpectroscopyResult;
import lucuma.itc.shared.ObservationDetails;
import lucuma.itc.shared.ObservingConditions;
import lucuma.itc.shared.S2NChart;
import lucuma.itc.shared.SignalChart;
import lucuma.itc.shared.SignalData;
import lucuma.itc.shared.SignalPixelChart;
import lucuma.itc.shared.SingleS2NData;
import lucuma.itc.shared.SourceDefinition;
import lucuma.itc.shared.SpcChartData;
import lucuma.itc.shared.SpcSeriesData;
...
public final class GmosRecipe implements ImagingArrayRecipe, SpectroscopyArrayRecipe {
    ...
    private Gmos createGmos(final GmosParameters parameters, final ObservationDetails observationDetails) {
        switch (parameters.legacySite()) {
            case GN: return new GmosNorth(parameters, observationDetails, 2);
    ...
    private static SpcChartData createSignalChart(final SpectroscopyResult[] results, final int i) {
        ...
        final scala.collection.immutable.List<SpcSeriesData> scalaData = CollectionConverters.asScala(data).toList();
        final scala.collection.immutable.List<ChartAxis>     scalaAxes = CollectionConverters.asScala(axes).toList();
