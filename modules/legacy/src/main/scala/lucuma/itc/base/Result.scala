...
import lucuma.itc.operation._
import lucuma.itc.base.AOSystem
...
// sealed trait Slit
// sealed trait SpecS2N
// sealed trait ImageQualityCalculatable
// sealed trait ImagingS2NCalculatable
// sealed trait SourceFraction
...
final case class SpectroscopyResult(
                      ...
                      aoSystem:         Option[AOSystem]) extends Result {
  lazy val peakPixelCount: Double = 0//specS2N.map(_.getPeakPixelCount).max
}
